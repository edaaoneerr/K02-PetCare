package com.example.petcareproject.adapters.messageadapters
...
class ChatAdapter(private val chats: List<Chat>, private val currentUserId: String, private val listener: OnItemClickListener) : RecyclerView.Adapter<ChatAdapter.ChatViewHolder>() {
